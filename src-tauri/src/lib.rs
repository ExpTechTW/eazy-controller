  ...
  tauri::Builder::default()
    .plugin({
      ...
      Builder::new()
        ...
        .shortcut(KeyboardShortcut::with_modifiers("r", &[ModifierKey::CtrlKey]))
        .build()
    })
    ...
    .setup(|app| {
      ...
      let http_server = Arc::new(
        http_server::HttpServer::new().with_asset_resolver(asset_resolver)
      );
      let http_server_clone = Arc::clone(&http_server);

      tauri::async_runtime::spawn(async move {
        http_server_clone.start(80).await;
      });
